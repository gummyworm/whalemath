 ...
 * mat4x4_perspective
******************************************************************************/
void mat4x4_perspective(Mat4x4 *mat, float fov, float aspect, float zNear, float zFar)
{
 ...
 * mat4x4_orthographic
******************************************************************************/
void mat4x4_orthographic(Mat4x4 *mat, float left, float right, float top, float bottom, float nearZ, float farZ)
{
